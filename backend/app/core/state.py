...
class GraphState(TypedDict):
    ...
    hypotheses: list[str]
    # Stored as plain dicts ({text, source, score}), not RetrievedChunk model
    # instances - state is checkpointed via msgpack, which warns on (and will
    # eventually refuse) unregistered custom types.
