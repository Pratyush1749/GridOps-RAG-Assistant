...
class Settings(BaseSettings):
    ...
    # OpenAI-compatible endpoint for the fallback LLM. Default = Groq. Point at
    # http://localhost:11434/v1 to use a local Ollama server (no API key needed).
    ...
    database_url: str = "postgresql://postgres:postgres@localhost:5433/adv_rag"
    ...
    # Text2SQL generation model. (Historically named vanna_*, but Vanna was never
    # actually used - SQL is generated by a plain schema-aware OpenAI call.)
